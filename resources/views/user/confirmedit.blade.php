    ...
    <div class="row justify-content-center">
      <div class="col-md-8">
        <div class="card border-primary">
          <div class="card-header bg-primary text-white">{{ __('Update User Confirmation') }}</div>
          <div class="card-body">
            ...
            @else
              <img src="{{ url('uploads/'.$user->profile) }}" class="position-absolute profile d-inline img-thumbnail right">
            @endif
            <form method="POST" action="{{ route('users#update', $user->id) }}">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <input id="type" type="text" class="form-control d-none" name="type" value="{{ $user->type }}">
                  <p class="txt-confirm">
                    @if ($user->type == '0')
                      Admin
                    @else
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <input id="phone" type="hidden" class="form-control @error('phone') is-invalid @enderror" name="phone"
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <input id="dob" type="hidden" class="form-control @error('dob') is-invalid @enderror" name="dob"
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  <input id="address" type="hidden" class="form-control @error('address') is-invalid @enderror"
              ...
              <div class="form-group row d-none">
                ...
                <div class="col-md-6">
                  <input id="profile" type="text" class="form-control @error('profile') is-invalid @enderror"
                    name="profile" value="{{ $user->profile }}" required autocomplete="profile" autofocus>
                </div>
              </div>
              ...
              <div class="form-group row mb-0">
                <div class="col-md-6 offset-md-4">
                  ...
                  <a href="{{ route('register') }}" class="btn btn-danger">{{ __('Cancel') }}</a>
                </div>
              </div>
            </form>
          </div>
